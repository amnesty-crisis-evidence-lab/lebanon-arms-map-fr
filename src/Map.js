  ...
  useEffect(() => {
    const initialiseMap = ({ setMap, containerRef }) => {
      const map = new mapboxgl.Map({
        ...
        style: "mapbox://styles/amnestydecoders/ckk5psq1p0rmj17mkudy7k95z",
      ...
      map.on("load", () => {
        ...
        map.on("click", "unclustered-point", e => {
          ...
          new mapboxgl.Popup()
            ...
            .setHTML(
              `<strong>Date de l’événement:</strong> ${eventDate}<br><strong>Type d’armes:</strong> ${tooltip}<br><strong>Longitude:</strong> ${longitude.toFixed(
                4
